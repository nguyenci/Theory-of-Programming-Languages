...
interp :: Expr -> Int
interp (Lit num) = num
interp (Op oper num1 num2) = interpBinOp oper (interp num1) (interp num2)
...
-- <FILL-IN>
peephole optimizer (Lit num) = Lit num
peephole optimizer (Op oper num1 num2) =
  optimizer (Op oper (peephole optimizer num1) (peephole optimizer num2))
-- </FILL-IN>
...
-- <FILL-IN>
step (IPush num) stack = Just $ num : stack
step _ [] = Nothing
step _ [_] = Nothing
step (IOp b) (x1 : x2 : xs) = Just $ interpBinOp b x2 x1 : xs
-- step (IOp _) _= Nothing
-- </FILL-IN>
...
-- <FILL-IN>
run instr stack = foldM (flip step) stack instr
-- </FILL-IN>
...
compile :: Expr -> [Instr]
-- <FILL-IN>
compile (Lit num) = [IPush num]
compile (Op oper num1 num2) = compile num1 ++ compile num2 ++ [IOp oper]
-- </FILL-IN>
