 ...
 * each takes a list and a function f. For each element in the list, the 
 * function calls f with the element and the index of the element in the 
 * list.
 */
 ...
 */
{
  let nr = 0; // track number of times function was executed
