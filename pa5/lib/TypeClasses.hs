...
dOrdXY dict_a dict_b = MkOrd {
    compare = c
} where 
    c (a1,b1) (a2,b2) =
        case compare dict_a a1 a2 of
            EQ -> compare dict_b b1 b2
            r -> r
...
-- <FILL-IN>
dOrdYX dict_a dict_b = MkOrd {
    compare = c
} where 
    c (a1,b1) (a2,b2) =
        case compare dict_b b1 b2 of
            EQ -> compare dict_a a1 a2
            r -> r
-- </FILL-IN>
...
isSorted _ [] = True
isSorted _ [_] = True
isSorted dict_a (x:x':xs) = 
    case compare dict_a x x' of 
        GT -> False 
        _ -> isSorted dict_a (x':xs)
-- </FILL-IN>
